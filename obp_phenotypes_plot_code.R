...
surv_lifespan_m<-filter(surv,sex=="M")
surv_lifespan_f<-filter(surv,sex=="F")

# lifespan under starvation plot

lifespan_plot_F<- ggplot(surv_lifespan_f,aes(Line,Lifespan_under_starvation_hours))+geom_boxplot(fill="pink")+theme_classic()+ggtitle("Lifespan under starvation (females)")+ ylab("Lifespan (h)")+theme(aspect.ratio=1)+theme(plot.title = element_text(hjust = 0.5))+scale_y_continuous(limits = c(0, 80))+xlab("")
lifespan_plot_F

lifespan_plot_M<- ggplot(surv_lifespan_m,aes(Line,Lifespan_under_starvation_hours))+geom_boxplot(fill="lightblue")+theme_classic()+ggtitle("Lifespan under starvation (males)")+ ylab("Lifespan (h)")+theme(aspect.ratio=1)+theme(plot.title = element_text(hjust = 0.5))+scale_y_continuous(limits = c(0, 80))+xlab("")
lifespan_plot_M
